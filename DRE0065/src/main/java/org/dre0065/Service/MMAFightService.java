...
public class MMAFightService
{
    ...
    public void saveMMAFight(MMAFight mmaFight) {mmaFightRepository.save(mmaFight);}
    public void deleteMMAFightById(int mmaFightId) {mmaFightRepository.deleteById(mmaFightId);}
}